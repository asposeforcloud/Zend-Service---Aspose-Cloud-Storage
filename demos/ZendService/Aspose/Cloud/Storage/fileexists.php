 ...
 *
 * In this demo application, 'AsposeLibraryTechnicalDetails.docx' confirms whether file on Aspose Cloud Storage exists or not.
 *
...
echo $folder->fileExists('testfile.jpeg');